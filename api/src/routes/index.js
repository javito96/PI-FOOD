...
const getApiInfo= async () => {
    const apiUrl = await axios.get("https://api.spoonacular.com/recipes/complexSearch?apiKey=8b3b81aa6ed047b08e353cb828d81133&addRecipeInformation=true&number=50")
